<template>
  <div class="container">
    <div class="wrap">
      ...
      <div class="list_wrap">
        <!-- <span class="course_title">同步课</span> -->
        <ul class="list_content clearfix">
          <li class="one_category" v-for="(item,index) in Course" :key="index">
            <div class="course_card" v-for="(course,index) in item.courses" :key="index">
            ...
            <!-- <ul class="card_item">
              <li class="course_card" v-for="(course,index) in item.courses" :key="index">
                <div class="card_title">
                  <span class="card_title_icon">英语</span>
                  <span>{{course.courseName}}</span>
                </div>
